...
<body class="alt-menu sidebar-noneoverflow">
    ...
    <div class="max-w-7xl" style="z-index:50">
        <a id="whatsapp-link" href="https://api.whatsapp.com/send?phone=5611107255" class="fixed bottom-4 right-4 p-4 bg-green-500 text-white rounded-full shadow-lg"  style=" z-index:30; @media (max-width: 768px) { margin: 0 120px 0px 0; z-index:30; }">
